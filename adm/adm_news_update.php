            ...
            <div class="col-sm-6">
                ...
                <br><hr><br>
                    ...
                    <fieldset class="form-group">
                        ...
                        <textarea rows="10" cols="30" name="textNews" class="form-control" ><?php echo $result[3]?></textarea>
                    </fieldset>
                    <button type="submit" class="btn btn-primary" name="789">Зберегти зміни</button><br>
                    <fieldset class="form-group">
                            <label for="userfile">Виберіть інші зображення</label><br>
                    ...
                    $text=$_POST['textNews'];
                    $text1=substr($text, 0, 90);
                    $id=$result[0];
                    $sql="UPDATE news SET title='$title', text_start='$text1', text='$text' WHERE id='$id'";
                    $res=mysqli_query($connect,$sql);
                    if($res){
